...
- Parts Overview:
  - Part 1 — Exploration (`part1_exploration.ipynb`): EDA of leads, campaigns, insights; qualified-rate logic; campaign metrics assembly. Outputs (if re-run) write to `dashboard/data/`.
  - Part 2 — Dashboard (`dashboard/part2_dashboard/app.py`): Streamlit app with Executive, Performance, Trends, Cost, and Quality views. Reads from `dashboard/data/`.
...
- Data Canonicalization:
  - All notebooks and the dashboard read from `dashboard/data/`.
...
- How to Run:
  ...
  - Dashboard: `streamlit run dashboard\\part2_dashboard\\app.py`
