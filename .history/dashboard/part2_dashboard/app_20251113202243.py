...
if dashboard_choice == "📊 Executive Summary":
    ...
    if metrics_df.empty:
        ...
        with col_chart1:
            ...
            spend_by_campaign = metrics_df.nlargest(10, 'spend')[['campaign_id', 'spend']].sort_values('spend', ascending=True)
        ...
        with col_chart2:
            ...
            leads_by_campaign = metrics_df.nlargest(10, 'num_leads')[['campaign_id', 'num_leads']].sort_values('num_leads', ascending=True)
